...
#  nonbackground_indices_x = np.any(False, axis=0)
#  nonbackground_indices_y = np.any(False, axis=1)
...
def main(_):
  ...
  print examples_path, examples_list
  ...
  #select part of examples as trainset;valset nums are 155*0.3= 47
